...
/**
  ...
  */
class CommentServiceImpl @Inject()(commentDAO: CommentDAO,
  ...
  override def createComment(addComment: AddComment, user: User): Future[Comment] = {
  ...
  override def editComment(editComment: EditComment, user: User): Future[Comment] = {
  ...
  override def getComment(commentID: String, withUserID: String): Future[Option[Comment]] = {
    commentDAO.getCommentsDetails(commentID, withUserID)
  }

  override def getCommentWithSubComments(commentID: String, user: Option[User]): Future[Option[Comment]] = {
  ...
  override def editSubComment(editComment: EditComment, user: User): Future[SubComment] = {
  ...
  override def createSubComment(addSubComment: AddSubComment, user: User): Future[SubComment] = {
  ...
  override def addCommentActivityFromUser(userID: String, commentID: String, data: UserCommentActivity): Future[UserCommentActivity] = {
  ...
  override def getHotCommentsForArticle(articleID: String, user: Option[User], pageNumber: Int, numberOfRecords: Int): Future[PaginatedResult[Comment]] = {
  ...
  override def getNewCommentsForArticle(articleID: String, user: Option[User], pageNumber: Int, numberOfRecords: Int): Future[PaginatedResult[Comment]] = {
  ...
  override def getHotSubCommentsForComment(commentID: String, user: Option[User], pageNumber: Int, numberOfRecords: Int): Future[PaginatedResult[SubComment]] = {
  ...
  override def getNewSubCommentsForComment(commentID: String, user: Option[User], pageNumber: Int, numberOfRecords: Int): Future[PaginatedResult[SubComment]] = {
